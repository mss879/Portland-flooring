        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-6 mt-6">
              {/* Instagram */}
              <a href="https://www.instagram.com/portland_flooring/" target="_blank" rel="noopener noreferrer" className="text-[#8c5430] hover:text-[#251208] transition-colors" aria-label="Instagram">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/people/Portland-Flooring/61582009910148/" target="_blank" rel="noopener noreferrer" className="text-[#8c5430] hover:text-[#251208] transition-colors" aria-label="Facebook">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
