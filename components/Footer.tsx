        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-6 mt-6">
              {/* Instagram */}
              <a href="https://www.instagram.com/portland_flooring/" target="_blank" rel="noopener noreferrer" className="text-[#8c5430] hover:text-[#251208] transition-colors" aria-label="Follow Portland Flooring on Instagram" title="Follow Portland Flooring on Instagram">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/people/Portland-Flooring/61582009910148/" target="_blank" rel="noopener noreferrer" className="text-[#8c5430] hover:text-[#251208] transition-colors" aria-label="Follow Portland Flooring on Facebook" title="Follow Portland Flooring on Facebook">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
                <span className="sr-only">Facebook</span>
              </a>
              {/* Pinterest — uncomment when URL available
              ...
              */}
              {/* Google Profile — uncomment when URL available
        ...
        <div className="flex flex-col gap-6 pt-8 border-t border-[#8c5430]/20">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
             ...
             <div className="flex gap-6">
               <span className="text-[#251208]/50 text-sm font-bold uppercase tracking-widest cursor-default">Privacy Policy</span>
               <span className="text-[#251208]/50 text-sm font-bold uppercase tracking-widest cursor-default">Terms of Service</span>
             </div>
          </div>
