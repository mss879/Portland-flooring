...
export const metadata: Metadata = {
  description:
    "Premium hybrid flooring solutions — elegant, durable, sustainable. Expert installation, restoration & design consultation serving Braeside, Melbourne & all of Victoria. Proudly Australian owned.",
  alternates: {
