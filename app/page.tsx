          ...
          <div className="relative z-10 flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-[24px] bg-black shadow-2xl">
            ...
            >
              ...
              <div className="relative z-10 flex items-center gap-8">
                ...
                <button
                  className="relative ml-4 rounded-md px-6 py-2.5 font-bold text-white uppercase tracking-wider text-base shadow-[0_4px_10px_rgba(140,84,48,0.3)] border border-[#8c5430]/30 transition-all hover:-translate-y-0.5 hover:shadow-[0_6px_15px_rgba(140,84,48,0.4)] active:translate-y-0.5"
                >
                  <div
