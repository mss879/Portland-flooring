      ...
      <main className="flex flex-col min-h-screen w-full bg-[#faf6f3]">
        ...
        <section className="relative w-full h-[50vh] min-h-[400px] flex flex-col justify-center items-center bg-[#110804] overflow-hidden px-8">
          ...
          <div className={`relative z-10 text-center flex flex-col items-center gap-4 ${isLoaded ? 'animate-slide-in-up' : 'opacity-0'}`}>
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold text-white tracking-wider leading-tight drop-shadow-lg" style={{ fontFamily: "'Signwood', serif" }}>
              Fusion Hybrid
            </h1>
          </div>
        </section>
        ...
        <section className="relative w-full -mt-16 z-20 px-8 md:px-12 lg:px-24 mb-20">
          <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-[2rem] p-10 flex flex-col justify-start shadow-sm hover:shadow-2xl transition-all duration-700 relative overflow-hidden group border border-[#8c5430]/10 hover:-translate-y-2">
              ...
              <h3 className="relative z-10 text-3xl font-black text-[#251208] mb-4 tracking-wider group-hover:text-[#4a2810] transition-colors duration-500" style={{ fontFamily: "Impact, ui-sans-serif, system-ui, sans-serif" }}>Eco-Friendly</h3>
            ...
            <div className="bg-white rounded-[2rem] p-10 flex flex-col justify-start shadow-sm hover:shadow-2xl transition-all duration-700 relative overflow-hidden group border border-[#8c5430]/10 hover:-translate-y-2 delay-100">
              ...
              <h3 className="relative z-10 text-3xl font-black text-[#251208] mb-4 tracking-wider group-hover:text-[#4a2810] transition-colors duration-500" style={{ fontFamily: "Impact, ui-sans-serif, system-ui, sans-serif" }}>CE Certified</h3>
            ...
            <div className="bg-white rounded-[2rem] p-10 flex flex-col justify-start shadow-sm hover:shadow-2xl transition-all duration-700 relative overflow-hidden group border border-[#8c5430]/10 hover:-translate-y-2 delay-200">
              ...
              <h3 className="relative z-10 text-3xl font-black text-[#251208] mb-4 tracking-wider group-hover:text-[#4a2810] transition-colors duration-500" style={{ fontFamily: "Impact, ui-sans-serif, system-ui, sans-serif" }}>Floorscore Certified</h3>
        ...
        <section className="py-20 px-8 md:px-12 lg:px-24">
          <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center gap-16">
            <div className="flex-1 space-y-6">
              ...
              <h3 className="text-4xl md:text-5xl font-black text-[#251208] leading-tight" style={{ fontFamily: "Impact, ui-sans-serif, system-ui, sans-serif" }}>
        ...
        <section className="py-24 px-8 md:px-12 lg:px-24 bg-[#1a0d07] relative overflow-hidden">
          <div className="max-w-[1400px] mx-auto flex flex-col items-center">
            <div className="text-center mb-16 space-y-4">
              ...
              <h3 className="text-4xl md:text-6xl font-extrabold text-white" style={{ fontFamily: "'Signwood', serif" }}>
        ...
        <section className="py-20 px-8 md:px-12 lg:px-24 bg-white border-y border-[#8c5430]/10">
          <div className="max-w-[1400px] mx-auto text-center">
            <h3 className="text-3xl md:text-4xl font-extrabold text-[#251208] mb-6" style={{ fontFamily: "Impact, ui-sans-serif, system-ui, sans-serif" }}>
        ...
        <section className="py-24 px-8 md:px-12 lg:px-24 bg-[#faf6f3]">
          <div className="max-w-[1400px] mx-auto">
            <h3 className="text-4xl md:text-5xl font-black text-[#251208] text-center mb-16" style={{ fontFamily: "Impact, ui-sans-serif, system-ui, sans-serif" }}>
              Why Hybrid flooring?
            </h3>
        ...
        <section className="py-24 px-8 md:px-12 lg:px-24 bg-[#fbf5f0]">
          <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center gap-16">
            <div className="flex-1 space-y-6">
              <h3 className="text-4xl font-black text-[#251208] leading-tight" style={{ fontFamily: "Impact, ui-sans-serif, system-ui, sans-serif" }}>
