...
export default function AboutUs() {
  ...
  return (
    <main className="flex flex-col min-h-screen w-full bg-[#fbf5f0]">
      ...
      {/* Premium Footer (Dark) */}
      <footer className="relative z-20 w-full pt-16 pb-8 bg-[#110804]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
            ...
            <div className="flex flex-col gap-6">
              ...
              <ul className="flex flex-col gap-4">
                ...
                <li><Link href="/fusion-hybrid" className="text-[#fce8d5]/60 hover:text-[#fdf2e9] text-sm font-medium transition-colors hover:translate-x-1 inline-block transform duration-300">Hybrid Hardwood</Link></li>
              </ul>
            </div>
            <div className="flex flex-col gap-6">
              <h4 className="text-white font-bold tracking-widest uppercase text-xs">Company</h4>
              <ul className="flex flex-col gap-4">
                <li><Link href="/about" className="text-[#fce8d5]/60 hover:text-[#fdf2e9] text-sm font-medium transition-colors hover:translate-x-1 inline-block transform duration-300">About Us</Link></li>
                <li><Link href="/services" className="text-[#fce8d5]/60 hover:text-[#fdf2e9] text-sm font-medium transition-colors hover:translate-x-1 inline-block transform duration-300">Services</Link></li>
