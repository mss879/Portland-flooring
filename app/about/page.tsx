        ...
        <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row relative">
          ...
          <div className="w-full lg:w-1/2 lg:h-screen lg:sticky lg:top-0 flex flex-col justify-center px-8 py-20 md:px-12 lg:px-20 border-r border-[#8c5430]/10 bg-[#fbf5f0] z-10">
            <div className="flex flex-col gap-12 max-w-xl">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-[#251208]" style={{ fontFamily: "'Tomorrow', sans-serif", fontWeight: 700 }}>
              ...
              {specialisms.map((spec, index) => (
                ...
                >
                  ...
                  <div className="space-y-4">
                    <h3 className="text-2xl md:text-3xl font-bold tracking-tight text-[#251208] group-hover:text-[#8c5430] transition-colors duration-300" style={{ fontFamily: "'Tomorrow', sans-serif" }}>
                      {spec.title}
                    </h3>
